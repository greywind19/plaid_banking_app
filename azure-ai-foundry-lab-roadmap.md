...
5. Once it works by hand, reproduce the resources as Terraform (a `foundry` module).
...
> **App Service** instead — same container, better networking/ingress options.
...
> Tip: keep your lab infra/code in a dedicated repo (e.g. `amansahota_microsoft/azure-labs`)
> so each phase is a commit and you can diff how the architecture grew.
